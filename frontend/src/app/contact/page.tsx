...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0a174e] via-[#1e2746] to-[#111216] flex flex-col items-center justify-center pt-28 pb-16 px-2 relative overflow-hidden">
      ...
      <p className="mb-12 text-xl text-white/80 max-w-2xl text-center animate-fade-in">¿Una pregunta? ¿Un proyecto? ¿Necesita acompañamiento? Complete el formulario premium de abajo o contáctenos directamente por correo.</p>
      <div className="w-full max-w-4xl flex flex-col md:flex-row gap-12 items-stretch animate-fade-in-up z-10">
        ...
        <div className="flex-1 bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl pt-20 pb-10 px-6 md:pt-24 md:pb-16 md:px-16 flex flex-col gap-8 border border-white/10 relative overflow-visible">
          ...
          {sent && (
            <div className="absolute top-8 left-1/2 -translate-x-1/2 bg-gradient-to-r from-primary to-accent text-white px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 font-semibold text-lg animate-fade-in z-20">
              <FaCheckCircle style={{ color: '#86efac', fontSize: '1.5rem' }} /> ¡Mensaje enviado con éxito!
            </div>
          )}
          <form className="flex flex-col gap-6 mt-12" onSubmit={handleSubmit}>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1 flex items-center gap-3 bg-white/20 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-primary">
                ...
                <input className="bg-transparent outline-none w-full text-white placeholder-white/70 text-lg" placeholder="Su nombre" required />
              </div>
              <div className="flex-1 flex items-center gap-3 bg-white/20 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-primary">
                <FaEnvelope style={{ color: 'var(--tw-color-primary, #0ea5e9)', fontSize: '1.25rem' }} />
                <input className="bg-transparent outline-none w-full text-white placeholder-white/70 text-lg" placeholder="Su correo electrónico" type="email" required />
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white/20 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-primary">
              ...
              <input className="bg-transparent outline-none w-full text-white placeholder-white/70 text-lg" placeholder="Su teléfono (opcional)" type="tel" />
            </div>
            <div className="flex items-start gap-3 bg-white/20 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-primary">
              ...
              <textarea className="bg-transparent outline-none w-full text-white placeholder-white/70 text-lg resize-none min-h-[120px]" placeholder="Su mensaje" required />
            </div>
          ...
          <div className="flex flex-col items-center gap-2 mt-4">
            <div className="flex gap-2">
              <span className="inline-flex items-center gap-1 bg-green-700/30 text-green-200 px-3 py-1 rounded-full text-xs font-semibold"><FaCheckCircle style={{ color: '#bbf7d0', fontSize: '1rem' }} /> Respuesta en 24 horas</span>
              <span className="inline-flex items-center gap-1 bg-blue-700/30 text-blue-200 px-3 py-1 rounded-full text-xs font-semibold"><FaLock style={{ color: '#60a5fa', fontSize: '1rem' }} /> Datos seguros</span>
            </div>
            <div className="text-center text-white/60 text-sm">Le responderemos en 24 horas. Sus datos permanecerán confidenciales.</div>
          </div>

          {/* Carrousel vidéos témoignages/présentation */}
          <div className="w-full flex flex-col items-center mt-8">
            <h2 className="text-xl font-bold text-white mb-4">Descubra nuestros videos</h2>
        ...
        <div className="flex-1 flex flex-col gap-8 justify-center items-center bg-gradient-to-br from-white/10 to-white/5 rounded-3xl shadow-xl p-8 border border-white/10 min-h-[420px] relative overflow-hidden">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-lg text-white font-semibold">Oficina principal</span>
          </div>
...
Santo Domingo Norte
Rep Dom<br/></div>
          <div className="text-white/80 text-center mb-2">Soporte 24/7 : <span className="font-semibold text-white">1-(809) 308-6370</span></div>
